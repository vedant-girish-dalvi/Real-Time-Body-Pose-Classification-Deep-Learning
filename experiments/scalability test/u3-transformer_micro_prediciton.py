...
consumer = KafkaConsumer(
    'rokoko-source-mocap03_processed',                  # Specify the topic name
    bootstrap_servers='192.168.50.234:29093', # Specify the Kafka broker(s)
    group_id='62', # Specify the consumer group ID
    ...
    json_body = [
        {
            ...
            "time": current_time,
            "fields": {
                "u3_prediction_value": field1,
                "u3_latency": field2,
                "u3_inference_latency":field3,
                "u3_cpu_usage":field4,
                "u3_memory_usage":field5,
                "u3_data_throughput":field6
            }
        }
    ]
