...
CSV_FILE_PATH = r"C:\Users\vedan\Desktop\data\60 FPS - clipped\user-wise\train\user-2_train.csv" 
...
df = pd.read_csv(CSV_FILE_PATH, usecols=features)
df.fillna(0, inplace=True)


new_user_data = generate_new_user_data(df, noise_std=0.1, scaling_factor=0.01)
