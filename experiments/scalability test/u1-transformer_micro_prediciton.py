...
consumer = KafkaConsumer(
    'rokoko-source-mocap01_processed',                  # Specify the topic name
    bootstrap_servers='192.168.50.234:29093', # Specify the Kafka broker(s)
    group_id='55', # Specify the consumer group ID
    ...
    json_body = [
        {
            ...
            "time": current_time,
            "fields": {
                "u1_prediction_value": field1,
                "u1_latency": field2,
                "u1_inference_latency":field3,
                "u1_cpu_usage":field4,
                "u1_memory_usage":field5,
                "u1_data_throughput":field6
            }
        }
    ]
