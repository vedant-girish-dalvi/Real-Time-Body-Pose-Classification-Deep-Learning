...
consumer = KafkaConsumer(
    ...
    group_id='51', # Specify the consumer group ID
...
def predict(test_data):
    ...
    end_time = time.time()
    save_to_influx("micro_gru", np.ndarray.item(results), end_time - start_time, predict_end - predict_start, cpu_usage, memory_usage)
